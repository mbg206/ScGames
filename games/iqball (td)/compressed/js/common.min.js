...
!1,cursorOverMenu=!0,outOfGame=!0,enableDebugDraw=!1,enableLog=!1,sGroup,siteLock=!1,siteLockCheck=!0,unLockAllLevels=!1,allowedDomain=["stage.coolmath-games.com","m-stage.coolmath-games.com","www.coolmath-games.com","m.coolmath-games.com,","coolmathgames.com","www.coolmathgames.com","m.coolmathgames.com"],currentDomain=document.location.host,parentDomain="",referrer=document.referrer;""!==referrer&&(parentDomain=referrer.split("/")[2]);siteLockCheck&&(/* 0>allowedDomain.indexOf(currentDomain)||""!==parentDomain&&0>allowedDomain.indexOf(parentDomain) */ false)&&(siteLock=!0);
...
this.game.winner.play())):this.endOfLevel()},endOfLevel:function(){this.state.start("LevelComplete")},endOfGame:function(){updateStorage();restartGame()},createSprites:function(){var a=this.game.level.getSprites(),b;for(b in a){var c=this.game.level.getPosition(b+"X");var d=this.game.level.getPosition(b+"Y");var a=this.game.level.getPosition(b+"scaleX"),e=this.game.level.getPosition(b+"scaleY");"sun"==b?this.sun=createSunAnimation(this,this.sunFrameSpeed,c,d,a,e):(c=this.game.add.sprite(c,d,b),a&&
