...
window.JellyTruck.state.load = {
	...
	//if (window.localStorage) window.localStorage.removeItem("jellytruck");
	if(window.localStorage.getItem("jellytruck")===null)
            { 
                jt.InitData()
    ...
    update:function() {
	if( window.localStorage.getItem("jellytruck")!==null && this.ready && this.game.cache.checkSoundKey("end_of_Level_yeah"))
	{
